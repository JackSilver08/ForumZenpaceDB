...
namespace ForumZenpace.Migrations
{
    ...
    [Migration("20260417145453_AddGroupInvitations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ForumZenpace.Models.GroupBan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ForumZenpace.Models.Story", b =>
                {
                    ...
                    b.Property<string>("MusicContentType")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<string>("MusicOriginalFileName")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
            ...
            modelBuilder.Entity("ForumZenpace.Models.User", b =>
                {
                    ...
                    b.Property<string>("PreferenceVectorData")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ForumZenpace.Models.DirectMessage", b =>
                {
                    ...
                    b.HasOne("ForumZenpace.Models.DirectMessage", "ReplyToMessage")
                        .WithMany("Replies")
